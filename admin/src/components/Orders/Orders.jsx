...
import { Search, CheckCircle, Truck, XCircle, MapPin, PackageCheck, AlertCircle } from 'lucide-react';
            ...
            {filteredOrders.map((order) => (
              <tr key={order._id}>
                <td className="font-mono text-xs text-gray-400">
                  <div className={`font-bold mb-1 ${order.orderType === 'Subscription-Generated' ? 'text-blue-500' : 'text-orange-500'}`}>
                    {order.orderType === 'Subscription-Generated' ? '🔄 SUB' : '⚡ ONE-TIME'}
                  </div>
